...
if os.path.isfile(leasesfile) is not True:
    print('| Leases file not found (' + leasesfile + ')')
    print('+----------------------------------------------------------------------------------------')
    exit(0)

myfile = open(leasesfile, 'r')
...
if len(report_dataset) > 0:
    ...
    print('| //////// No active leases on file (' + leasesfile + ')')
